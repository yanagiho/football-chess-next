/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 8f0b9fdf97e143e7a36fc04b3fd29d69)
// Runtime types generated with workerd@1.20260630.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "development";
	CONTENT_SLUG: "universofutbol-football-chess";
	PUBLIC_BASE_PATH: "/universofutbol/football-chess";
	UNIVERSO_FUTBOL_URL: "https://universofutbol.com";
	MATCH_ROOM: DurableObjectNamespace<import("./index").MatchRoom>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CONTENT_SLUG" | "PUBLIC_BASE_PATH" | "UNIVERSO_FUTBOL_URL">> {}
}
